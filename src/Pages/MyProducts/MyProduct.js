...
const MyProduct = ({product, handleDeleteProduct, handleAdvertice}) => {
  const{_id,image, title, location, phone, date, original, resale, name, year, advertice} =product;
    return (
        <div>
          {
            !advertice && <div className="card card-compact w-80 h-[70%] shadow-lg bg-black">
            <PhotoProvider>
             <PhotoView src={image}>
